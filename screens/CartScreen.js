...
export default function CartScreen({ navigation }) {
    const { cartItems, removeFromCart, incrementQuantity, decrementQuantity, recentlyViewedProducts } = useContext(CartContext);
                ...
                <View style={styles.suggestedInfo}>
                    ...
                    <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                        {recentlyViewedProducts.length > 0 ? (
                            ...
                            <Text style={styles.noProductsText}>No recently viewed products.</Text>
                        )}
